    ...
    return (
        ...
        >
            ...
            >
                ...
                <figure>
                    <img
                        className="w-full h-48 sm:h-56 md:h-64 lg:h-72 xl:h-80 object-cover rounded-t-md 
                ...
                <div
                    ...
                    rounded-b-md shadow text-center"
                >
                    <h2
                        className="text-base sm:text-lg md:text-xl lg:text-xl font-semibold text-blue-400
